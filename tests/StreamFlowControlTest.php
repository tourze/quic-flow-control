 ...
 * @internal
 */
#[CoversClass(StreamFlowControl::class)]
final class StreamFlowControlTest extends TestCase
{
    public function testConstruction(): void
    {
        $controller = new StreamFlowControl(1);
    ...
    {
        $controller = new StreamFlowControl(1, 1000, 2000);
        $this->assertEquals(1, $controller->getStreamId());
    ...
    public function testConstructionWithNegativeStreamId(): void
    {
        ...
        new StreamFlowControl(-1);
    }

    public function testCanSend(): void
    {
        $controller = new StreamFlowControl(1, 1000, 1000);
